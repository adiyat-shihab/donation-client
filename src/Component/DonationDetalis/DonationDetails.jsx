    ...
    <>
      ...
      >
        <div className={"relative"}>
          ...
          <div
            className={
              " px-4 py-4 bottom-0 w-[24.5rem] md:w-[44rem] absolute  bg-[#0b0b0b80]  lg:w-[59rem]   xl:w-[72.5rem] 2xl:w-[101.5rem] md:px-[2.31rem] md:py-[2.31rem] md:h-[8.125rem] "
            }
          >
            <button
              className={
                "md:px-[1.62rem] px-2 py-2 md:py-4 text-white rounded "
              }
